...
class DecodedMetadata {
	...
	public pure nothrow @trusted this(ubyte id, ubyte type, sul.protocol.minecraft315.types.Slot value) {
		this.id = id;
		this.type = type;
		this.slot = value;
	}
	...
	public pure nothrow @trusted this(ubyte id, ubyte type, sul.protocol.minecraft315.types.OptionalPosition value) {
		this.id = id;
		this.type = type;
		this.optional_position = value;
	}

	public pure nothrow @trusted this(ubyte id, ubyte type, sul.protocol.minecraft315.types.OptionalUuid value) {
		this.id = id;
		this.type = type;
		this.uuid = value;
	}
