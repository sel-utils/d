...
class Metadata {
	...
	private Changed!(sul.protocol.java340.types.Slot) _potion;
	...
	private Changed!(sul.protocol.java340.types.OptionalPosition) _beamTarget;
	private Changed!(bool) _showBottom;
	private Changed!(sul.protocol.java340.types.Slot) _firework;
	private Changed!(uint) _fireworkThrower;
	private Changed!(sul.protocol.java340.types.Slot) _item;
	...
	private Changed!(sul.protocol.java340.types.OptionalUuid) _ownerUuid;
	...
	private Changed!(sul.protocol.java340.types.OptionalPosition) _shulkerAttachment;
	...
	public pure nothrow @property @safe @nogc sul.protocol.java340.types.Slot potion() {
		return _potion.value;
	}

	public pure nothrow @property @safe sul.protocol.java340.types.Slot potion(sul.protocol.java340.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.java340.types.OptionalPosition beamTarget() {
		return _beamTarget.value;
	}

	public pure nothrow @property @safe sul.protocol.java340.types.OptionalPosition beamTarget(sul.protocol.java340.types.OptionalPosition value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.java340.types.Slot firework() {
		return _firework.value;
	}

	public pure nothrow @property @safe sul.protocol.java340.types.Slot firework(sul.protocol.java340.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.java340.types.Slot item() {
		return _item.value;
	}

	public pure nothrow @property @safe sul.protocol.java340.types.Slot item(sul.protocol.java340.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.java340.types.OptionalUuid ownerUuid() {
		return _ownerUuid.value;
	}

	public pure nothrow @property @safe sul.protocol.java340.types.OptionalUuid ownerUuid(sul.protocol.java340.types.OptionalUuid value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.java340.types.OptionalPosition shulkerAttachment() {
		return _shulkerAttachment.value;
	}

	public pure nothrow @property @safe sul.protocol.java340.types.OptionalPosition shulkerAttachment(sul.protocol.java340.types.OptionalPosition value) {
		this._cached = false;
...
class DecodedMetadata {
	...
	union {
		...
		string string_;
		string chat;
		sul.protocol.java340.types.Slot slot;
		bool bool_;
		Tuple!(float, "x", float, "y", float, "z") rotation;
		ulong position;
		sul.protocol.java340.types.OptionalPosition optional_position;
		uint direction;
		sul.protocol.java340.types.OptionalUuid uuid;
		uint block;
		ubyte[] nbt;
	}
	...
	public static pure nothrow @trusted DecodedMetadata fromSlot(ubyte id, sul.protocol.java340.types.Slot value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromOptionalPosition(ubyte id, sul.protocol.java340.types.OptionalPosition value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromUuid(ubyte id, sul.protocol.java340.types.OptionalUuid value) {
