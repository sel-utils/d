...
class DecodedMetadata {
	...
	union {
		...
		string string_;
		string chat;
		sul.protocol.minecraft316.types.Slot slot;
		bool bool_;
		Tuple!(float, "x", float, "y", float, "z") rotation;
		ulong position;
		sul.protocol.minecraft316.types.OptionalPosition optional_position;
		uint direction;
		sul.protocol.minecraft316.types.OptionalUuid uuid;
		uint block;
	}
