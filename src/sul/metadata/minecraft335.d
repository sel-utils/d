...
class Metadata {
	...
	private Changed!(sul.protocol.minecraft335.types.Slot) _potion;
	...
	private Changed!(sul.protocol.minecraft335.types.OptionalPosition) _beamTarget;
	private Changed!(bool) _showBottom;
	private Changed!(sul.protocol.minecraft335.types.Slot) _firework;
	private Changed!(uint) _fireworkThrower;
	private Changed!(sul.protocol.minecraft335.types.Slot) _item;
	...
	private Changed!(sul.protocol.minecraft335.types.OptionalUuid) _ownerUuid;
	...
	private Changed!(sul.protocol.minecraft335.types.OptionalPosition) _shulkerAttachment;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft335.types.Slot potion() {
		return _potion.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft335.types.Slot potion(sul.protocol.minecraft335.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft335.types.OptionalPosition beamTarget() {
		return _beamTarget.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft335.types.OptionalPosition beamTarget(sul.protocol.minecraft335.types.OptionalPosition value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft335.types.Slot firework() {
		return _firework.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft335.types.Slot firework(sul.protocol.minecraft335.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft335.types.Slot item() {
		return _item.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft335.types.Slot item(sul.protocol.minecraft335.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft335.types.OptionalUuid ownerUuid() {
		return _ownerUuid.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft335.types.OptionalUuid ownerUuid(sul.protocol.minecraft335.types.OptionalUuid value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft335.types.OptionalPosition shulkerAttachment() {
		return _shulkerAttachment.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft335.types.OptionalPosition shulkerAttachment(sul.protocol.minecraft335.types.OptionalPosition value) {
		this._cached = false;
...
class DecodedMetadata {
	...
	public static pure nothrow @trusted DecodedMetadata fromSlot(ubyte id, sul.protocol.minecraft335.types.Slot value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromOptionalPosition(ubyte id, sul.protocol.minecraft335.types.OptionalPosition value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromUuid(ubyte id, sul.protocol.minecraft335.types.OptionalUuid value) {
