...
class Metadata {
	...
	private Changed!(sul.protocol.minecraft338.types.Slot) _potion;
	...
	private Changed!(sul.protocol.minecraft338.types.OptionalPosition) _beamTarget;
	private Changed!(bool) _showBottom;
	private Changed!(sul.protocol.minecraft338.types.Slot) _firework;
	private Changed!(uint) _fireworkThrower;
	private Changed!(sul.protocol.minecraft338.types.Slot) _item;
	...
	private Changed!(ubyte[]) _leftShoulder;
	private Changed!(ubyte[]) _rightShoulder;
	...
	private Changed!(sul.protocol.minecraft338.types.OptionalUuid) _ownerUuid;
	...
	private Changed!(uint) _parrotColor;
	...
	private Changed!(sul.protocol.minecraft338.types.OptionalPosition) _shulkerAttachment;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft338.types.Slot potion() {
		return _potion.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft338.types.Slot potion(sul.protocol.minecraft338.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft338.types.OptionalPosition beamTarget() {
		return _beamTarget.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft338.types.OptionalPosition beamTarget(sul.protocol.minecraft338.types.OptionalPosition value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft338.types.Slot firework() {
		return _firework.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft338.types.Slot firework(sul.protocol.minecraft338.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft338.types.Slot item() {
		return _item.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft338.types.Slot item(sul.protocol.minecraft338.types.Slot value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc ubyte[] leftShoulder() {
		return _leftShoulder.value;
	}

	public pure nothrow @property @safe ubyte[] leftShoulder(ubyte[] value) {
		this._cached = false;
		this._leftShoulder.value = value;
		if(!this._leftShoulder.changed) {
			this._leftShoulder.changed = true;
			this._changed ~= &this.encodeLeftShoulder;
		}
		return value;
	}

	public pure nothrow @safe encodeLeftShoulder(Buffer buffer) {
		with(buffer) {
			writeBigEndianUbyte(15);
			writeBigEndianUbyte(13);
			writeBytes(this._leftShoulder.value);
		}
	}

	public pure nothrow @property @safe @nogc ubyte[] rightShoulder() {
		return _rightShoulder.value;
	}

	public pure nothrow @property @safe ubyte[] rightShoulder(ubyte[] value) {
		this._cached = false;
		this._rightShoulder.value = value;
		if(!this._rightShoulder.changed) {
			this._rightShoulder.changed = true;
			this._changed ~= &this.encodeRightShoulder;
		}
		return value;
	}

	public pure nothrow @safe encodeRightShoulder(Buffer buffer) {
		with(buffer) {
			writeBigEndianUbyte(16);
			writeBigEndianUbyte(13);
			writeBytes(this._rightShoulder.value);
		}
	}
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft338.types.OptionalUuid ownerUuid() {
		return _ownerUuid.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft338.types.OptionalUuid ownerUuid(sul.protocol.minecraft338.types.OptionalUuid value) {
		this._cached = false;
	...
	public pure nothrow @property @safe @nogc uint parrotColor() {
		return _parrotColor.value;
	}

	public pure nothrow @property @safe uint parrotColor(uint value) {
		this._cached = false;
		this._parrotColor.value = value;
		if(!this._parrotColor.changed) {
			this._parrotColor.changed = true;
			this._changed ~= &this.encodeParrotColor;
		}
		return value;
	}

	public pure nothrow @safe encodeParrotColor(Buffer buffer) {
		with(buffer) {
			writeBigEndianUbyte(15);
			writeBigEndianUbyte(1);
			writeBytes(varuint.encode(this._parrotColor.value));
		}
	}
	...
	public pure nothrow @property @safe @nogc sul.protocol.minecraft338.types.OptionalPosition shulkerAttachment() {
		return _shulkerAttachment.value;
	}

	public pure nothrow @property @safe sul.protocol.minecraft338.types.OptionalPosition shulkerAttachment(sul.protocol.minecraft338.types.OptionalPosition value) {
		this._cached = false;
			...
			while(_index < _buffer.length && (id=readBigEndianUbyte()) != 255) {
				switch(readBigEndianUbyte()) {
					...
					case 13:
						...
						metadata.decoded ~= DecodedMetadata.fromNbt(id, _13);
						break;
					default:
						break;
				}
...
class DecodedMetadata {
	...
	union {
		...
		string string_;
		string chat;
		sul.protocol.minecraft338.types.Slot slot;
		bool bool_;
		Tuple!(float, "x", float, "y", float, "z") rotation;
		ulong position;
		sul.protocol.minecraft338.types.OptionalPosition optional_position;
		uint direction;
		sul.protocol.minecraft338.types.OptionalUuid uuid;
		uint block;
		ubyte[] nbt;
	}
	...
	public static pure nothrow @trusted DecodedMetadata fromSlot(ubyte id, sul.protocol.minecraft338.types.Slot value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromOptionalPosition(ubyte id, sul.protocol.minecraft338.types.OptionalPosition value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromUuid(ubyte id, sul.protocol.minecraft338.types.OptionalUuid value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromNbt(ubyte id, ubyte[] value) {
		auto ret = new DecodedMetadata(id, 13);
		ret.nbt = value;
		return ret;
	}
