...
class DecodedMetadata {
	...
	union {
		...
		string string_;
		string chat;
		sul.protocol.minecraft210.types.Slot slot;
		bool bool_;
		Tuple!(float, "x", float, "y", float, "z") rotation;
		ulong position;
		sul.protocol.minecraft210.types.OptionalPosition optional_position;
		uint direction;
		sul.protocol.minecraft210.types.OptionalUuid uuid;
		uint block;
	}
	...
	public static pure nothrow @trusted DecodedMetadata fromSlot(ubyte id, sul.protocol.minecraft210.types.Slot value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromOptionalPosition(ubyte id, sul.protocol.minecraft210.types.OptionalPosition value) {
	...
	public static pure nothrow @trusted DecodedMetadata fromUuid(ubyte id, sul.protocol.minecraft210.types.OptionalUuid value) {
