...
static import sul.protocol.minecraft338.types;

static if(__traits(compiles, { import sul.metadata.minecraft338; })) import sul.metadata.minecraft338;
...
class Statistics : Buffer {
	...
	public sul.protocol.minecraft338.types.Statistic[] statistics;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(sul.protocol.minecraft338.types.Statistic[] statistics) {
...
class UpdateBlockEntity : Buffer {
	...
	public enum ubyte BED_COLOR = 11;
...
class MultiBlockChange : Buffer {
	...
	public sul.protocol.minecraft338.types.BlockChange[] changes;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(Tuple!(int, "x", int, "z") chunk, sul.protocol.minecraft338.types.BlockChange[] changes=(sul.protocol.minecraft338.types.BlockChange[]).init) {
		this.chunk = chunk;
...
class WindowItems : Buffer {
	...
	public ubyte window;
	public sul.protocol.minecraft338.types.Slot[] slots;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(ubyte window, sul.protocol.minecraft338.types.Slot[] slots=(sul.protocol.minecraft338.types.Slot[]).init) {
		this.window = window;
		this.slots = slots;
	}
...
class SetSlot : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, sul.protocol.minecraft338.types.Slot item=sul.protocol.minecraft338.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.item = item;
	}
...
class Map : Buffer {
	...
	public sul.protocol.minecraft338.types.Icon[] icons;
	public ubyte colums;
	public ubyte rows;
	...
	public pure nothrow @safe @nogc this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, sul.protocol.minecraft338.types.Icon[] icons=(sul.protocol.minecraft338.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "x", ubyte, "z") offset=Tuple!(ubyte, "x", ubyte, "z").init, ubyte[] data=(ubyte[]).init) {
		this.mapId = mapId;
		this.scale = scale;
...
class CraftRecipeResponse : Buffer {
	...
	public enum string[] FIELDS = ["window", "recipe"];
	...
	public pure nothrow @safe @nogc this(ubyte window, uint recipe=uint.init) {
		this.window = window;
		this.recipe = recipe;
	}
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		...
		static if(writeId){ writeBytes(varuint.encode(ID)); }
		writeBigEndianUbyte(window);
		writeBytes(varuint.encode(recipe));
		return _buffer;
	}
	...
	public pure nothrow @safe void decode(bool readId=true)() {
		static if(readId){ uint _id; _id=varuint.decode(_buffer, &_index); }
		window=readBigEndianUbyte();
		recipe=varuint.decode(_buffer, &_index);
	}

	public static pure nothrow @safe CraftRecipeResponse fromBuffer(bool readId=true)(ubyte[] buffer) {
...
class PlayerListItem : Buffer {
	...
	public class AddPlayer {
		...
		public sul.protocol.minecraft338.types.ListAddPlayer[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.minecraft338.types.ListAddPlayer[] players) {
	...
	public class UpdateGamemode {
		...
		public sul.protocol.minecraft338.types.ListUpdateGamemode[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.minecraft338.types.ListUpdateGamemode[] players) {
			this.players = players;
		}
	...
	public class UpdateLatency {
		...
		public sul.protocol.minecraft338.types.ListUpdateLatency[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.minecraft338.types.ListUpdateLatency[] players) {
			this.players = players;
		}
	...
	public class UpdateDisplayName {
		...
		public sul.protocol.minecraft338.types.ListUpdateDisplayName[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.minecraft338.types.ListUpdateDisplayName[] players) {
			this.players = players;
		}
...
class UnlockRecipes : Buffer {
	...
	// action
	public enum uint ADD = 1;
	public enum uint REMOVE = 2;
	public enum uint ADD_WITHOUT_NOTIFICATION = 3;

	public enum string[] FIELDS = ["action", "openBook", "filtering", "recipes", "bookRecipes"];
	...
	public pure nothrow @safe @nogc this(uint action, bool openBook=bool.init, bool filtering=bool.init, uint[] recipes=(uint[]).init, uint[] bookRecipes=(uint[]).init) {
		this.action = action;
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		...
		static if(writeId){ writeBytes(varuint.encode(ID)); }
		writeBytes(varuint.encode(action));
		writeBigEndianBool(openBook);
		writeBigEndianBool(filtering);
		writeBytes(varuint.encode(cast(uint)recipes.length)); foreach(cvabc;recipes){ writeBytes(varuint.encode(cvabc)); }
		if(action==1||action==3){ writeBytes(varuint.encode(cast(uint)bookRecipes.length)); foreach(y9ajylzm;bookRecipes){ writeBytes(varuint.encode(y9ajylzm)); } }
		return _buffer;
	}
	...
	public pure nothrow @safe void decode(bool readId=true)() {
		static if(readId){ uint _id; _id=varuint.decode(_buffer, &_index); }
		action=varuint.decode(_buffer, &_index);
		openBook=readBigEndianBool();
		filtering=readBigEndianBool();
		recipes.length=varuint.decode(_buffer, &_index); foreach(ref cvabc;recipes){ cvabc=varuint.decode(_buffer, &_index); }
		if(action==1||action==3){ bookRecipes.length=varuint.decode(_buffer, &_index); foreach(ref y9ajylzm;bookRecipes){ y9ajylzm=varuint.decode(_buffer, &_index); } }
	}

	public static pure nothrow @safe UnlockRecipes fromBuffer(bool readId=true)(ubyte[] buffer) {
...
class AdvancementProgress : Buffer {
	...
	public enum string[] FIELDS = ["notEmpty", "identifier"];
	...
	public pure nothrow @safe @nogc this(bool notEmpty, string identifier=string.init) {
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		_buffer.length = 0;
		static if(writeId){ writeBytes(varuint.encode(ID)); }
		writeBigEndianBool(notEmpty);
		if(notEmpty==true){ writeBytes(varuint.encode(cast(uint)identifier.length)); writeString(identifier); }
		return _buffer;
	}

	public pure nothrow @safe void decode(bool readId=true)() {
		static if(readId){ uint _id; _id=varuint.decode(_buffer, &_index); }
		notEmpty=readBigEndianBool();
		if(notEmpty==true){ uint arbrzlc=varuint.decode(_buffer, &_index); identifier=readString(arbrzlc); }
	}

	public static pure nothrow @safe AdvancementProgress fromBuffer(bool readId=true)(ubyte[] buffer) {
...
class EntityEquipment : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, uint slot=uint.init, sul.protocol.minecraft338.types.Slot item=sul.protocol.minecraft338.types.Slot.init) {
		this.entityId = entityId;
		this.slot = slot;
		this.item = item;
	}
...
class Advencements : Buffer {
	...
	public static pure nothrow @safe Advencements fromBuffer(bool readId=true)(ubyte[] buffer) {
...
class EntityProperties : Buffer {
	...
	public uint entityId;
	public sul.protocol.minecraft338.types.Attribute[] attributes;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(uint entityId, sul.protocol.minecraft338.types.Attribute[] attributes=(sul.protocol.minecraft338.types.Attribute[]).init) {
		this.entityId = entityId;
