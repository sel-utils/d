...
class ClickWindow : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, sul.protocol.minecraft338.types.Slot clickedItem=sul.protocol.minecraft338.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.button = button;
		this.action = action;
...
class CraftRecipeRequest : Buffer {
	...
	public enum string[] FIELDS = ["window", "recipe", "makeAll"];
	...
	public pure nothrow @safe @nogc this(ubyte window, uint recipe=uint.init, bool makeAll=bool.init) {
		this.window = window;
		this.recipe = recipe;
	...
	public pure nothrow @safe void decode(bool readId=true)() {
		...
		makeAll=readBigEndianBool();
	}

	public static pure nothrow @safe CraftRecipeRequest fromBuffer(bool readId=true)(ubyte[] buffer) {
...
class CreativeInventoryAction : Buffer {
	...
	public pure nothrow @safe @nogc this(ushort slot, sul.protocol.minecraft338.types.Slot clickedItem=sul.protocol.minecraft338.types.Slot.init) {
		this.slot = slot;
		this.clickedItem = clickedItem;
	}
