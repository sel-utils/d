...
class CraftingGrid : Buffer {
	...
	public enum string[] FIELDS = ["window", "action", "returnEntry", "prepareEntry"];

	public ubyte window;
	public ushort action;
	public sul.protocol.minecraft333.types.Entry[] returnEntry;
	public sul.protocol.minecraft333.types.Entry[] prepareEntry;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(ubyte window, ushort action=ushort.init, sul.protocol.minecraft333.types.Entry[] returnEntry=(sul.protocol.minecraft333.types.Entry[]).init, sul.protocol.minecraft333.types.Entry[] prepareEntry=(sul.protocol.minecraft333.types.Entry[]).init) {
		this.window = window;
		this.action = action;
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		...
		writeBigEndianUshort(cast(ushort)returnEntry.length); foreach(cvdjr5ck;returnEntry){ cvdjr5ck.encode(bufferInstance); }
		writeBigEndianUshort(cast(ushort)prepareEntry.length); foreach(cjcfzvdj;prepareEntry){ cjcfzvdj.encode(bufferInstance); }
		return _buffer;
	}
	...
	public pure nothrow @safe void decode(bool readId=true)() {
		...
		returnEntry.length=readBigEndianUshort(); foreach(ref cvdjr5ck;returnEntry){ cvdjr5ck.decode(bufferInstance); }
		prepareEntry.length=readBigEndianUshort(); foreach(ref cjcfzvdj;prepareEntry){ cjcfzvdj.decode(bufferInstance); }
	}

	public static pure nothrow @safe CraftingGrid fromBuffer(bool readId=true)(ubyte[] buffer) {
...
class ClickWindow : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, sul.protocol.minecraft333.types.Slot clickedItem=sul.protocol.minecraft333.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.button = button;
		this.action = action;
...
class CraftingBookData : Buffer {
	...
	public pure nothrow @safe @nogc this(uint type) {
		this.type = type;
	}
	...
	public static pure nothrow @safe CraftingBookData fromBuffer(bool readId=true)(ubyte[] buffer) {
	...
	public class DisplayedRecipe {
		...
		public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
			type = 1;
			_encode!writeId();
			writeBigEndianUint(id);
			return _buffer;
		}

		public pure nothrow @safe void decode() {
			id=readBigEndianUint();
		}
	...
	public class CraftingBookStatus {

		public enum typeof(type) TYPE = 2;

		public enum string[] FIELDS = ["bookOpened", "filtering"];
		...
		public pure nothrow @safe @nogc this(bool bookOpened, bool filtering=bool.init) {
		...
		public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
			type = 2;
			_encode!writeId();
			writeBigEndianBool(bookOpened);
			writeBigEndianBool(filtering);
			return _buffer;
		}

		public pure nothrow @safe void decode() {
			bookOpened=readBigEndianBool();
...
class AdvencementTab : Buffer {
	...
	// action
	public enum uint OPEN_TAB = 0;
	public enum uint CLOSE_SCREEN = 1;

	public enum string[] FIELDS = ["action", "tab"];
	...
	public pure nothrow @safe @nogc this(uint action, string tab=string.init) {
		this.action = action;
		this.tab = tab;
	}
	...
	public pure nothrow @safe ubyte[] encode(bool writeId=true)() {
		...
		static if(writeId){ writeBytes(varuint.encode(ID)); }
		writeBytes(varuint.encode(action));
		if(action==0){ writeBytes(varuint.encode(cast(uint)tab.length)); writeString(tab); }
		return _buffer;
	}
	...
	public pure nothrow @safe void decode(bool readId=true)() {
		static if(readId){ uint _id; _id=varuint.decode(_buffer, &_index); }
		action=varuint.decode(_buffer, &_index);
		if(action==0){ uint df=varuint.decode(_buffer, &_index); tab=readString(df); }
	}

	public static pure nothrow @safe AdvencementTab fromBuffer(bool readId=true)(ubyte[] buffer) {
...
class CreativeInventoryAction : Buffer {
	...
	public pure nothrow @safe @nogc this(ushort slot, sul.protocol.minecraft333.types.Slot clickedItem=sul.protocol.minecraft333.types.Slot.init) {
		this.slot = slot;
		this.clickedItem = clickedItem;
	}
