...
static import sul.protocol.java335.types;
...
class Statistics : Buffer {
	...
	public sul.protocol.java335.types.Statistic[] statistics;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(sul.protocol.java335.types.Statistic[] statistics) {
...
class MultiBlockChange : Buffer {
	...
	public sul.protocol.java335.types.BlockChange[] changes;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(Tuple!(int, "x", int, "z") chunk, sul.protocol.java335.types.BlockChange[] changes=(sul.protocol.java335.types.BlockChange[]).init) {
		this.chunk = chunk;
...
class WindowItems : Buffer {
	...
	public ubyte window;
	public sul.protocol.java335.types.Slot[] slots;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(ubyte window, sul.protocol.java335.types.Slot[] slots=(sul.protocol.java335.types.Slot[]).init) {
		this.window = window;
		this.slots = slots;
	}
...
class SetSlot : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, sul.protocol.java335.types.Slot item=sul.protocol.java335.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.item = item;
	}
...
class Map : Buffer {
	...
	public sul.protocol.java335.types.Icon[] icons;
	public ubyte colums;
	public ubyte rows;
	...
	public pure nothrow @safe @nogc this(uint mapId, ubyte scale=ubyte.init, bool showIcons=bool.init, sul.protocol.java335.types.Icon[] icons=(sul.protocol.java335.types.Icon[]).init, ubyte colums=ubyte.init, ubyte rows=ubyte.init, Tuple!(ubyte, "x", ubyte, "z") offset=Tuple!(ubyte, "x", ubyte, "z").init, ubyte[] data=(ubyte[]).init) {
		this.mapId = mapId;
		this.scale = scale;
...
class PlayerListItem : Buffer {
	...
	public class AddPlayer {
		...
		public sul.protocol.java335.types.ListAddPlayer[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.java335.types.ListAddPlayer[] players) {
	...
	public class UpdateGamemode {
		...
		public sul.protocol.java335.types.ListUpdateGamemode[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.java335.types.ListUpdateGamemode[] players) {
			this.players = players;
		}
	...
	public class UpdateLatency {
		...
		public sul.protocol.java335.types.ListUpdateLatency[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.java335.types.ListUpdateLatency[] players) {
			this.players = players;
		}
	...
	public class UpdateDisplayName {
		...
		public sul.protocol.java335.types.ListUpdateDisplayName[] players;

		public pure nothrow @safe @nogc this() {}

		public pure nothrow @safe @nogc this(sul.protocol.java335.types.ListUpdateDisplayName[] players) {
			this.players = players;
		}
...
class EntityEquipment : Buffer {
	...
	public pure nothrow @safe @nogc this(uint entityId, uint slot=uint.init, sul.protocol.java335.types.Slot item=sul.protocol.java335.types.Slot.init) {
		this.entityId = entityId;
		this.slot = slot;
		this.item = item;
	}
...
class EntityProperties : Buffer {
	...
	public uint entityId;
	public sul.protocol.java335.types.Attribute[] attributes;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(uint entityId, sul.protocol.java335.types.Attribute[] attributes=(sul.protocol.java335.types.Attribute[]).init) {
		this.entityId = entityId;
