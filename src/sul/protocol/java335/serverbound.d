...
class CraftingGrid : Buffer {
	...
	public sul.protocol.java335.types.Entry[] returnEntry;
	public sul.protocol.java335.types.Entry[] prepareEntry;

	public pure nothrow @safe @nogc this() {}

	public pure nothrow @safe @nogc this(ubyte window, ushort action=ushort.init, sul.protocol.java335.types.Entry[] returnEntry=(sul.protocol.java335.types.Entry[]).init, sul.protocol.java335.types.Entry[] prepareEntry=(sul.protocol.java335.types.Entry[]).init) {
		this.window = window;
		this.action = action;
...
class ClickWindow : Buffer {
	...
	public pure nothrow @safe @nogc this(ubyte window, ushort slot=ushort.init, ubyte button=ubyte.init, ushort action=ushort.init, uint mode=uint.init, sul.protocol.java335.types.Slot clickedItem=sul.protocol.java335.types.Slot.init) {
		this.window = window;
		this.slot = slot;
		this.button = button;
		this.action = action;
...
class CreativeInventoryAction : Buffer {
	...
	public pure nothrow @safe @nogc this(ushort slot, sul.protocol.java335.types.Slot clickedItem=sul.protocol.java335.types.Slot.init) {
		this.slot = slot;
		this.clickedItem = clickedItem;
	}
